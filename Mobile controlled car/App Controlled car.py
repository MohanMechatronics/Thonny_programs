...
# Servos
servo_aileron = machine.PWM(machine.Pin(9), freq=50)   # Aileron
servo_elevator = machine.PWM(machine.Pin(7), freq=50)  # Elevator (moved from 10 to 7)

# Motors
motor_low = machine.PWM(machine.Pin(8), freq=50)   # Motor for 0–1900 range
motor_high = machine.PWM(machine.Pin(10), freq=50) # Motor for 2200–4000 range
