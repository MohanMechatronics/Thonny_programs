...
down_elevator_btn  = machine.Pin(21, machine.Pin.IN, machine.Pin.PULL_UP)    # Down elevator trim
up_elevator_btn    = machine.Pin(22, machine.Pin.IN, machine.Pin.PULL_UP)    # Up elevator trim
...
elevator_mode_pin    = machine.Pin(18, machine.Pin.IN, machine.Pin.PULL_UP)  # Mode selection

# Control pins for rudder reverse function
rudder_mode_pin    = machine.Pin(17, machine.Pin.IN, machine.Pin.PULL_UP)   # Mode selection


elevator_reverse_pin = machine.Pin(14, machine.Pin.IN, machine.Pin.PULL_UP)  # Reverse control

rudder_reverse_pin = machine.Pin(13,  machine.Pin.IN, machine.Pin.PULL_UP)   # Reverse control
